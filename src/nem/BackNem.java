...
@Override 
 public void enterProg(BaknemParser.ProgContext ctx) {
  ...
  myOutput.out( "</ol></p>" );
  myOutput.out( "<p>This webpage and the following"+
  " MathML-based inkprint math backtranslation"+
  " of the braille math"+
  " were produced automatically by the"+
  " <a href=\"https://github.com/SusanJ/Baknem\">Backnem 2.0</a>"+
  " Java application using a two-step process."+
  " The first step analyzes the braille input"+
  " with an ANTLR 4 parser"+
  " generated from"+
  " the Nemeth grammar developed for"+
  " this project."+
  " The second step backtranslates the parser output"+  
  " with a custom process implemented in Java.</p>" );
